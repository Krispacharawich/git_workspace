package com.krisp.springmvc.controller;
...
import com.krisp.springmvc.service.EmployeeService;
...
public class AppController {
	...
	public String saveEmployee(@Valid Employee employee, BindingResult result, ModelMap model) {
		 ...
		 *  should be implement custom @Unique annotation
		 *  and apply it on field [ssn] of Model Class [Employee].
		 *  
		 *  Below mentioned peace of code [if block] is to demonstrate that
		 *  you can fill custom errors outside the validation
		 *  framework as well while still using internationalized messagaes.
		 */
	...
	/*
	 *  This method will called on form submission, handling
	 *  POST request for updating employee in database.
	...
	public String updateEmployee(@Valid Employee employee, BindingResult result
		...
		model.addAttribute("success","Employee "+employee.getName()+" updating successfully");
		return "success";
	}
